...
def _validate_data(data, columns):
    """Validate dict 'data' against columns mapping like {'col':'INTEGER'|'TEXT'|...}.
    ...
    for k, v in (data or {}).items():
        ...
        if 'INTEGER' in t:
            ...
            # ensure it's serializable to str
            try:
                str(v)
            except Exception:
                return False, f"column {k} expects text"
        # extend with other SNMP-specific validations (length, ranges) as needed
    return True, None
